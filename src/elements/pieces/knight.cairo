...
impl Knight of PieceTrait {
    ...
    fn can(index: u8, from: u8, to: u8, whites: u64, blacks: u64) -> bool {
        ...
        let is_valid = (d_row_abs == 2 && d_col_abs == 1) || (d_row_abs == 1 && d_col_abs == 2);
...
mod tests {
    ...
    #[test]
    fn test_pieces_knight_success() {
        let index = 9; // [A2]
        let whites = 0;
        let blacks = 0b00000010_00000000_00000000_00000000;
        assert_eq!(Knight::can(index, 9, 26, whites, blacks), true);
    }

    #[test]
    fn test_pieces_knight_not_valid() {
        let index = 9; // [A2]
        let whites = 0;
        let blacks = 0b00000010_00000000_00000000_00000000;
        assert_eq!(!Knight::can(index, 9, 25, whites, blacks), true);
    }

    #[test]
    fn test_pieces_knight_not_free() {
        let index = 9; // [A2]
    ...
    #[test]
    fn test_pieces_knight_not_available() {
        let index = 9; // [A2]
        let whites = 0b00000010_00000000_00000000_00000000;
        let blacks = 0;
        assert_eq!(!Knight::can(index, 9, 26, whites, blacks), true);
    }
}
