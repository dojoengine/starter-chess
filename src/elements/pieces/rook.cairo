...
impl Rook of PieceTrait {
    ...
    fn can(index: u8, from: u8, to: u8, whites: u64, blacks: u64) -> bool {
        ...
        let is_valid = from_row == to_row || from_col == to_col;
...
mod tests {
    ...
    #[test]
    fn test_pieces_rook_success() {
        let index = 9; // [A2]
        let whites = 0;
        let blacks = 0b00000001_00000000_00000000_00000000;
        assert_eq!(Rook::can(index, 9, 25, whites, blacks), true);
    }

    #[test]
    fn test_pieces_rook_not_valid() {
        let index = 9; // [A2]
        let whites = 0;
        let blacks = 0b00000001_00000000_00000000_00000000;
        assert_eq!(!Rook::can(index, 9, 26, whites, blacks), true);
    }

    #[test]
    fn test_pieces_rook_not_free() {
        let index = 9; // [A2]
    ...
    #[test]
    fn test_pieces_rook_not_available() {
        let index = 9; // [A2]
